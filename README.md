...
- [Запуск тестов](#запуск-тестов)
  - [1. Запустите приложение как описано в разделе](#1-запустите-приложение-как-описано-в-разделе-запуск-у-себя) [Запуск у себя](#запуск-у-себя)
  - [2. Зайдите в контейнер приложения](#2-зайдите-в-контейнер-приложения)
  - [3. После подключения к контейнеру запустите тесты](#3-после-подключения-к-контейнеру-запустите-тесты)
  - [4. Выйдите из контейнера приложения](#4-выйдите-из-контейнера-приложения)
...
# Запуск тестов
## 1. Запустите приложение как описано в разделе [Запуск у себя](#запуск-у-себя)
## 2. Зайдите в контейнер приложения
```bash
docker exec -it app /bin/sh
```
Где `app` - Это название docker контейнера с приложением. Указывается в `container_name` сервиса приложения в [docker-compose.yaml](docker-compose.yaml)
